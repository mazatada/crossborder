    ...
    def test_recall_rate(self, client: FlaskClient, api_key_header, test_cases):
        ...
        for case in test_cases:
            ...
            response = client.post(
                "/v1/classify/hs",
                json={"product": case["product"], "traceId": f"E2E-{case_id}"},
            ...
            if response.status_code == 200:
                ...
                if data.get("hs_candidates"):
                    data["hs_candidates"][0].get("confidence", 0.0)
            ...
            print(
                f"{status_mark} {case_id}: Expected {expected_hs}, Got {actual_hs} (Rev: {review_required})"
            )
