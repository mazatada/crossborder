...
class TestHSScorer:
    ...
    def test_calculate_confidence_basic(self):
        ...
        product_data = {"ingredients": [{"id": "ing_wheat_flour", "pct": 35.0}]}
    ...
    def test_should_review_low_confidence(self):
        ...
        assert scorer.should_review(top_candidate, rule_matches) is True
    ...
    def test_should_review_high_confidence(self):
        ...
        assert scorer.should_review(top_candidate, rule_matches) is False
    ...
    def test_should_review_by_rule_flag(self):
        ...
        rule_matches = [{"requires_review": True, "rule_id": "hs_food_004"}]
    ...
    def test_ingredient_factor_with_major_ingredient(self):
        ...
        product_data = {"ingredients": [{"id": "ing_wheat_flour", "pct": 40.0}]}
    ...
    def test_ingredient_factor_without_major_ingredient(self):
        ...
        product_data = {"ingredients": [{"id": "ing_sugar", "pct": 20.0}]}
