...
def test_receive_order_status_paid(client):
    ...
    resp = client.post("/v1/integrations/orders/ORDER-123/status", 
...
def test_receive_order_status_canceled(client):
    ...
    resp = client.post("/v1/integrations/orders/ORDER-456/status",
        headers={"X-API-Key": "dev-api-key-change-me"},
        json={
            "status": "CANCELED",
            "ts": "2025-12-03T11:00:00Z"
        }
    )
...
def test_receive_order_status_invalid_api_key(client):
    ...
    resp = client.post("/v1/integrations/orders/ORDER-789/status",
...
def test_receive_order_status_missing_api_key(client):
    ...
    resp = client.post("/v1/integrations/orders/ORDER-999/status",
        json={
            "status": "PAID",
            "ts": "2025-12-03T13:00:00Z"
        }
    )
...
def test_receive_order_status_invalid_status(client):
    ...
    resp = client.post("/v1/integrations/orders/ORDER-111/status",
        headers={"X-API-Key": "dev-api-key-change-me"},
        json={
            "status": "INVALID_STATUS",
            "ts": "2025-12-03T14:00:00Z"
        }
    )
...
def test_receive_order_status_missing_timestamp(client):
    ...
    resp = client.post("/v1/integrations/orders/ORDER-222/status",
        headers={"X-API-Key": "dev-api-key-change-me"},
        json={
            "status": "PAID"
        }
...
def test_receive_order_status_invalid_timestamp_format(client):
    ...
    resp = client.post("/v1/integrations/orders/ORDER-333/status",
        headers={"X-API-Key": "dev-api-key-change-me"},
        json={
            "status": "PAID",
            "ts": "not-a-timestamp"
