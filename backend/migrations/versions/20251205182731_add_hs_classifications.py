...
def upgrade():
    ...
    # インデックス作成
    op.create_index(
        "ix_hs_classifications_trace_id", "hs_classifications", ["trace_id"]
    )
    op.create_index(
        "ix_hs_classifications_product_id", "hs_classifications", ["product_id"]
    )
    op.create_index(
        "ix_hs_classifications_final_hs_code", "hs_classifications", ["final_hs_code"]
    )
    op.create_index(
        "ix_hs_classifications_category", "hs_classifications", ["category"]
    )
    op.create_index(
        "ix_hs_classifications_review_required",
        "hs_classifications",
        ["review_required"],
    )
...
def downgrade():
    ...
    op.drop_index(
        "ix_hs_classifications_review_required", table_name="hs_classifications"
    )
    op.drop_index("ix_hs_classifications_category", table_name="hs_classifications")
    op.drop_index(
        "ix_hs_classifications_final_hs_code", table_name="hs_classifications"
    )
